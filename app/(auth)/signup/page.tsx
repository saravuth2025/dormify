...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      window.location.href = `/dashboard/${formData.plan}`;
    }, 1500);
  };
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col lg:flex-row overflow-hidden">
      ...
      <div className="flex-1 flex flex-col justify-center px-8 sm:px-12 lg:px-16 py-12 relative z-10 bg-white overflow-y-auto scrollbar-none">
        <div className="max-w-md w-full mx-auto space-y-6">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            <div className="space-y-2.5">
              ...
              <div className="space-y-1">
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    className="h-11 pl-11 pr-4 rounded-lg border-border bg-transparent focus:ring-2 focus:ring-black/5 transition-all text-sm font-medium"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <select
                  ...
                  className="w-full h-11 px-4 bg-transparent border border-border rounded-lg text-sm font-medium focus:ring-2 focus:ring-black/5 outline-none transition-all"
                >
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  ...
                  <Input
                    ...
                    className="h-11 pl-11 pr-11 rounded-lg border-border bg-transparent focus:ring-2 focus:ring-black/5 transition-all text-sm font-medium"
                    required
                  />
                  <button
                    type="button"
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-11 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-bold text-base shadow-lg shadow-blue-600/20 active:scale-[0.98] transition-all mt-1"
            >
            ...
            <div className="relative flex items-center gap-4 py-1.5">
              ...
              <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest bg-white px-2">Or continue with</span>
              <div className="flex-1 h-px bg-border" />
            </div>
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full h-11 rounded-lg border-border hover:bg-muted font-semibold text-sm flex items-center justify-center gap-2 transition-all"
            >
