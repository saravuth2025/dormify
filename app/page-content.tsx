        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-24">
            <ScrollRevealText className="space-y-6">
              <Badge className="bg-primary/10 text-primary border-primary/20 px-4 py-1.5 text-[10px] font-bold uppercase tracking-[0.3em]">
                Core Services
              </Badge>
              <h2 className="text-5xl md:text-7xl font-bold tracking-tighter">
                All-in-One <br />
                <span className="text-muted-foreground/30 italic">Solutions.</span>
              </h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto font-medium">
                Streamlined management across every aspect of residential operations.
              </p>
            </ScrollRevealText>
          </div>
          ...
          >
            {SERVICES.map((service, i) => (
              <motion.div key={i} variants={fadeInUp}>
                <Card className="p-8 group hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 cursor-pointer border-border/50 hover:border-primary/30">
